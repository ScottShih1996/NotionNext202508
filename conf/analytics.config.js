...
module.exports = {
  ...
  ANALYTICS_GOOGLE_ID: process.env.NEXT_PUBLIC_ANALYTICS_GOOGLE_ID || 'G-FR287MH8MZ', // 谷歌Analytics的id e.g: G-XXXXXXXXXX
  ...
  // 微软 Clarity 站点分析
  CLARITY_ID: process.env.NEXT_PUBLIC_CLARITY_ID || 'nkmjyb34ql' // 只需要复制Clarity脚本中的ID部分，ID是一个十位的英文数字组合
